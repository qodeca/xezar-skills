...
The prompt `xez-brainstorm` gives the fresh-context subagent it dispatches once, at the convergence gate (workflow step 4). The subagent receives a summary of the conversation — the problem statement, the alternatives considered, the tentative conclusion and exit ramp — and this instruction:

...
and stop: `xez-ux-review-pr` for a pull request's running UI, `xez-ux-shape` in
...
**ALWAYS check first:** Apply `.xezar/pipeline/overrides/xez-ux-setup.md` when present; safety rules still win.

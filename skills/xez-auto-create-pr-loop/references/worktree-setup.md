...
Detailed procedure for step 6 (create) and step 14 (cleanup) of `xez-auto-create-pr-loop`. Never run in the user's primary worktree.
...
WORKTREE_PARENT="$REPO_ROOT/.local/tmp/xez-auto-create-pr-loop"
CREATED_WORKTREE=0

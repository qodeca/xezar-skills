...
Three modes. The authoritative end-of-run `xez-auto-review-pr` pass runs in **every** mode — it alone posts the PR review and drives labels. Step review is an internal quality gate: it posts nothing to the tracker.

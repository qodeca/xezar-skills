...
- No worktree setup here: the chain driver (`xez-auto-fix-issue` or an external flow runner) has already checked the repo out on an isolated branch in the current working directory — triage in place.

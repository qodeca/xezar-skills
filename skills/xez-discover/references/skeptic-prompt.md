...
The prompt `xez-discover` gives the fresh-context subagent it dispatches at step 6, once the draft brief has passed the quality gate. The subagent receives the draft, the coverage line, the mode, and the list of research files, and this instruction:

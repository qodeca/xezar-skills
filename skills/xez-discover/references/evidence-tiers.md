...
Every claim in the brief carries a tag naming the strongest tier it honestly supports, and a pointer to its source. The tag is part of the contract with the reader — and with `xez-spec-writing`, which turns untagged or weakly tagged claims into Open Questions.

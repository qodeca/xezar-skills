...
How `xez-discover` asks. The body's rules are the contract; this file is technique.
...
- where the brief lands: `SPECS_DIR` from the config, `.xezar/pipeline/specs` without one (never a question);

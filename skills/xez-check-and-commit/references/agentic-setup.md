...
## xez-check-and-commit specifics

- This skill performs **no tracker operations and no label mutations**. The descriptor read in Preflight step 2 only confirms the pipeline is set up; nothing in this skill calls it.

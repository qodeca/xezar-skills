...
is a whole module, flow, or existing product area, run the `xez-ux-shape` skill
...
**ALWAYS check first:** Apply `.xezar/pipeline/overrides/xez-ux-review-pr.md` when present; safety rules still win.

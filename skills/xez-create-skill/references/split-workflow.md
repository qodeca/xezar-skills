...
The full procedure `xez-create-skill` follows to refactor an existing oversized
`SKILL.md` into layered `references/` **without changing behavior**. This is the
§9 process from `references/philosophy.md`. The body enters this file for split mode.

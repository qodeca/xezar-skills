...
How `xez-create-skill` writes a skill's `description`. This is the single
...
## What a good pipeline skill description contains
...
- **An explicit "when to use"** with concrete **trigger phrases**, in **English**
  ...
  `"new xez-skill"`, `"split this skill"`, `"refactor SKILL.md"`.

...
The full procedure `xez-create-skill` follows to turn a brief into a new
...
Confirm the derived name is kebab-case, `xez-`-prefixed, verb-first (matching the
...
- Optionally `.xezar/pipeline/overrides/<name>.md` as a repo-local stub from

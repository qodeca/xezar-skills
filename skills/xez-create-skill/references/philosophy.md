...
How `xez-create-skill` decides what stays in the body and what goes to
`references/`. This is the operational checklist this skill follows (the reasoning
behind it lives in the collection's `DECISIONS.md`). Applies to both modes.

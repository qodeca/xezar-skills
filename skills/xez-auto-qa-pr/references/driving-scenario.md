...
Detailed procedure for step 9 of `xez-auto-qa-pr`. Exercise the scenario against `BASE_URL`, capturing a screenshot at each verification point into `$ARTIFACTS_DIR`:

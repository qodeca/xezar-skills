...
Detailed procedure for the check-out and cleanup steps of `xez-auto-qa-pr` (PR mode). Never verify in the user's primary worktree.
...
WORKTREE_PARENT="$REPO_ROOT/.local/tmp/xez-auto-qa-pr"
CREATED_WORKTREE=0

...
- **Record lessons.** A bootstrap failure that taught you a prerequisite goes into the repo-local override file, the generated scripts, and the descriptor notes before you finish — next time must not repeat it.

...
Detailed procedure for step 5 (create) and step 13 (cleanup) of `xez-auto-create-pr`. Never run in the user's primary worktree.
...
WORKTREE_PARENT="$REPO_ROOT/.local/tmp/xez-auto-create-pr"
CREATED_WORKTREE=0

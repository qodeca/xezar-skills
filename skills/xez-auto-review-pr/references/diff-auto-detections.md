...
The severity-tagged pattern tables the `xez-auto-review-pr` body scans the PR diff
against in step 7, before running the full `xez-code-review` skill. When a pattern

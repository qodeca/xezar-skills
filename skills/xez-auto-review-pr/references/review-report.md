# Review and report — the xez-code-review pass plus the autofix loop

Detailed procedure for step 8 (full review pass) and step 11 (autonomous autofix and fix-forward loop) of `xez-auto-review-pr`. This skill is itself the automated second pass that other skills in this collection invoke; the review engine underneath is always the `xez-code-review` skill, executed verbatim inside the isolated worktree.

## Review pass (step 8)

Use the `xez-code-review` skill against the PR diff. Explicitly verify:
...
## xez-auto-review-pr specifics — pass scope and gates (step 8)
...
## xez-auto-review-pr specifics — autonomous autofix flow (step 11)
...
## xez-auto-review-pr specifics — fix-forward loop (step 11)

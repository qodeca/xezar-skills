...
Detailed procedure for step 5 (create) and step 12 (cleanup) of `xez-auto-review-pr`. Never review directly in the repository's primary worktree.
...
WORKTREE_PARENT="$REPO_ROOT/.local/tmp/xez-auto-review-pr"
CREATED_WORKTREE=0

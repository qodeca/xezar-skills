...
`.xezar/pipeline/specs`) or the repo's design-doc areas — including their asset folders
...
skeleton conventions (the `xez-spec-writing` skill's structure, when installed).

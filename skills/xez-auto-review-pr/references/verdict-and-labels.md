...
Detailed procedure for step 10 of `xez-auto-review-pr`. The authoritative label invariants also live in the skill's **Rules** section; this file is the step-by-step mechanics.
...
Post the concise `xez-code-review` report as the authoritative review body.

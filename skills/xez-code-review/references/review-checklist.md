...
When the pipeline config (`.xezar/pipeline/config.json`) sets `reviewChecklist`, apply that repo-local file in addition to this one — it extends these rules, never replaces them.

...
Detailed procedure for step 4 (create) and step 11 (cleanup) of `xez-auto-continue-pr-loop`. Never resume in the user's primary worktree.
...
WORKTREE_PARENT="$REPO_ROOT/.local/tmp/xez-auto-continue-pr-loop"
CREATED_WORKTREE=0

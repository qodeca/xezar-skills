...
```markdown
{✅ or 🔁 or ⛔} `xez-auto-continue-pr-loop`: {what changed; ready, incomplete or blocked, and why.}
...
{Next review/QA decision, or first remaining Step and `xez-auto-continue-pr-loop {prNumber}`.}
```

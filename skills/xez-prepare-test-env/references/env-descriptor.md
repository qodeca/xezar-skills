...
(`xez-auto-qa-pr`, `xez-integration-tests`) always attach to the same instance:
...
```json
{
  ...
  "startScript": ".xezar/pipeline/scripts/test-env-up.sh",
  "stopScript": ".xezar/pipeline/scripts/test-env-down.sh",
  ...
  "credentialsFile": ".local/qa/test-env.env",
  "browser": {
    "provider": "agent-browser",
    "installed": true,
    "command": "<absolute cached command path or repository runner command>",
    "version": "<version>",
    "descriptor": ".xezar/pipeline/browsers/agent-browser.md",
    "notes": ""
  },

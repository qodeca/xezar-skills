...
A sweep that consumes and emits no chaining reference lines itself — each delegated review reports its own verdict and markers. It requires [xez-auto-review-pr](xez-auto-review-pr.md) (reused verbatim per PR; the run stops if it is missing) and optionally suggests [xez-merge-buddy](xez-merge-buddy.md) afterward to show what is now merge-ready.

---
*Source: [`skills/xez-review-prs/SKILL.md`](../../skills/xez-review-prs/SKILL.md)*

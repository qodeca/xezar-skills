...
Reads finished pull requests and their comments, reviews, and labels through the tracker, and produces a classified report only. When you decide to act on the top-ranked cause, it hands off to [xez-prepare-issue](xez-prepare-issue.md), which deduplicates against existing issues and labels the result itself.

---
*Source: [`skills/xez-pipeline-retro/SKILL.md`](../../skills/xez-pipeline-retro/SKILL.md)*

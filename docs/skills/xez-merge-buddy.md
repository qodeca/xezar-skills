...
Reads open PRs and their check status through the tracker and produces a classified report only. When you pick a PR to ship, it hands off to [xez-approve-merge-pr](xez-approve-merge-pr.md), which re-checks the same gates before actually merging.

---
*Source: [`skills/xez-merge-buddy/SKILL.md`](../../skills/xez-merge-buddy/SKILL.md)*

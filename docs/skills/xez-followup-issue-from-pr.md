...
Consumes a PR/comment URL and emits one or more tracker issues (follow-up issues and/or an `Implement:` tracking issue), cross-linking design PRs to their tracking issues. It suggests picking implementation back up later with [xez-auto-create-pr](xez-auto-create-pr.md) using the linked design doc as the brief.

---
*Source: [`skills/xez-followup-issue-from-pr/SKILL.md`](../../skills/xez-followup-issue-from-pr/SKILL.md)*

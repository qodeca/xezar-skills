...
Consumes a `{prNumber}` (the `PR:` reference line a PR-producing skill emitted) and ends by emitting the `PR:` / `Issue:` chaining reference lines. It orchestrates [xez-auto-review-pr](xez-auto-review-pr.md) (review + autofix + conflict/fork handling), [xez-auto-qa-pr](xez-auto-qa-pr.md) (UI QA), and [xez-followup-issue-from-pr](xez-followup-issue-from-pr.md) (nit follow-ups), then hands the merge-ready PR to [xez-approve-merge-pr](xez-approve-merge-pr.md); CI stabilization is built in.

---
*Source: [`skills/xez-auto-fix-pr/SKILL.md`](../../skills/xez-auto-fix-pr/SKILL.md)*
